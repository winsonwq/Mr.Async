...
define(function(require, exports, module){
	...
	var ev = EV.extend({
		...
		revisit : function(expresssion, name){
			this._Mr = name || 'Mr';
			return this.base(expresssion);
		},
		_Mr : 'Mr',
		...
		_recodeLoop : function(condition, block, outerBefore, after, afterIteration){
			...
			this._append(this._Mr + '.asynIterator(' + this._Mr + '.infinite(), function(cnt){');
			...
			this._append('}else{');
			this._append('return ' + this._Mr + '.BREAK;');
			this._append('}');
			this._append('}');
